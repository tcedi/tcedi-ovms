/* keyboard layout template (copy of "alpha" from the core plugin)
 */
jQuery.keyboard.layouts['alphasmall'] = {
	'name' : 'alphasmall',
	'lang' : ['en'], // this setting must match the "all" language definition below
	'normal': [
