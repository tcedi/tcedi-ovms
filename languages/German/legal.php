...
//German translation for legal.php.

$TEXT_VISITOR_BADGE = 'T.C.E.D.I. Open Visitors Management System';
$TEXT_AGREE = 'Einverstanden';
$TEXT_DECLINE = 'Ablehnen';
$TEXT_I_DIGITALLY_SIGN_THE_NON_DISCLOSURE_AGREEMENT = 'Ich unterzeichne die Geheimhaltungsvereinbarung digital, indem ich "'.$TEXT_AGREE.'" wähle.';
?>
