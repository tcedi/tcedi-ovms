...
//French translation for legal.php.

$TEXT_VISITOR_BADGE = 'T.C.E.D.I. Open Visitors Management System';
$TEXT_AGREE = 'Accepter';
$TEXT_DECLINE = 'Refuser';
$TEXT_I_DIGITALLY_SIGN_THE_NON_DISCLOSURE_AGREEMENT = 'Je signe numériquement l\'Accord de Non-Divulgation en cliquant sur "'.$TEXT_AGREE.'".';
?>
